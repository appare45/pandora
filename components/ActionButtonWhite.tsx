...
const Action_button_white = (props: {
  ...
  return (
    <button
      className={`flex w-full md:w-auto items-center justify-center bg-gray-100 md:bg-gray-50 border border-gray-300 md:border-gray-300 text-gray-500 h-10 px-3 text-sm rounded-md m-1  whitespace-nowrap ${

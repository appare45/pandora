...
const EventInfo = React.memo((props: { userData: DocumentData }) => {
  ...
  return (
    <div className="bg-blue-50 p-5 flex flex-col items-center justify-center">
      ...
      <div className="md:p-10 py-5 flex-1">
        <p className="text-lg">イベント名：{currentEvent?.name}</p>
        <p className="text-lg">説明：{currentEvent?.description}</p>
      </div>
    </div>
  );
});
